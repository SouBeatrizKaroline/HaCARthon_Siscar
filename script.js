...
// ==========================================
    // GRUPO 25: A LEGISLAÇÃO E OS DOCUMENTOS DO CAR
    // ==========================================
    "manual de credito rural mcr": "O MCR é a bíblia dos bancos na hora de emprestar dinheiro para o produtor. É o livreto de regras do Banco Central que diz quem pode e quem não pode pegar financiamento. Hoje em dia, por exemplo, está escrito lá bem claro que para liberar o dinheiro da lavoura, o banco tem que ver o seu Recibo do CAR primeiro.",
    "portaria mapa 121 de 2021": "Essa portaria do Ministério da Agricultura veio para organizar a bagunça na hora de analisar os dados. Ela deu um roteiro padrão para os técnicos do governo conferirem as informações do CAR e jogarem os resultados direto para dentro do sistema do SICAR, agilizando as aprovações.",
    "medida provisoria 884 de 2019": "Essa MP veio para mexer no Código Florestal e tirar de vez o fantasma do prazo final de inscrição para quem quer ter os benefícios da lei. Ela deixou claro que o CAR é permanente, tirando a data limite que ficava assombrando o produtor.",
    "portaria do ministerio da defesa 2018": "Essa regra serviu para colocar ordem nos quartéis e terras das Forças Armadas. Ela reconheceu que os imóveis militares (da Marinha, Exército e Aeronáutica) têm uma situação especial por causa da segurança nacional, mas também precisam ser registrados no CAR.",
    "decreto 9640 de 2018": "Esse decreto foi o que tentou clarear as regras da CRA (Cota de Reserva Ambiental). Ele explicou como as cotas de floresta devem ser criadas e negociadas no mercado, criando as bases para esse mercado de venda e aluguel de mata verde.",
    "medida provisoria 867 de 2018": "Essa foi mais uma das canetadas do governo para empurrar o prazo de adesão ao PRA (Programa de Regularização Ambiental) mais para frente, dando mais tempo para os estados se organizarem e para o produtor não perder o direito de limpar suas multas.",
    "resolucao numero 3 de 2018": "Essa resolução criou o status 'Suspenso' no sistema do CAR. Sabe quando o governo pega uma fraude muito na cara ou um erro grave na terra e trava o cadastro até o dono se explicar? Pois é, essa regra foi criada para dar esse 'cartão amarelo' no sistema.",
    "resolucao 4663 de 2018": "Essa foi a regra do Banco Central que deu uma colher de chá para o produtor na época, adiando a data em que os bancos passariam a exigir o Recibo do CAR de forma obrigatória na hora de liberar o crédito rural.",
    "decretos de prorrogacao 2017 e 2018": "Tanto o Decreto 9.257 (de 2017) quanto o 9.395 (de 2018) foram remédios para o mesmo mal: o prazo do CAR estava vencendo, o povo da roça não estava conseguindo fazer a tempo e o governo foi lá e esticou o prazo por mais um ano para ninguém ficar fora da lei.",
    "resolucao 4529 de 2016": "Essa resolução deu uma ajeitada nas linhas de crédito mais famosas do país, como o Pronaf (para agricultura familiar) e o Pronamp (para o médio produtor), mudando os juros e os prazos para bater certinho com o que o novo Código Florestal mandava.",
    "lei 13335 de 2016": "Essa lei nasceu da antiga MP 724 e serviu para dar fôlego ao pequeno produtor, dando mais um ano de prazo para o dono de minifúndio e a agricultura familiar fazerem o CAR com todos os direitos garantidos.",
    "lei 13295 de 2016": "Outra lei importante de prazo! Ela esticou a data final da inscrição do CAR até o fim de 2017 e amarrou o prazo do crédito agrícola, garantindo que o produtor pudesse pegar dinheiro no banco enquanto o cadastro estivesse andando.",
    "instrucao normativa icmbio 5 de 2016": "Essa instrução veio para resolver a vida de quem comprou terra dentro de Parque Nacional ou Reserva Federal e quer doar essa área para o governo para pagar a dívida de Reserva Legal do seu sítio. Ela explicou o passo a passo para o ICMBio aceitar essa troca.",
    "instrucao ibama 12 de 2014": "Essa norma foi o ponto de partida para quem queria congelar as multas de desmatamentos antigos (feitos antes de 2008). Ela ensinou como pedir para o Ibama suspender as punições e trocar as multas em dinheiro por serviços de plantio e recuperação de florestas.",
    "instrucao normativa mma 2 de 2014": "Esse é o manual geral de operação do CAR. Foi essa instrução que criou o SICAR e explicou para os estados como o sistema de computador deveria funcionar, como desenhar os mapas e como juntar os dados do Brasil inteiro num lugar só.",
    "decreto 8235 de 2014": "Esse decreto criou o famoso programa 'Mais Ambiente Brasil' e trouxe as regras gerais para os estados criarem os seus PRAs. Foi ele quem garantiu que, quem assinasse o Termo de Compromisso, ficaria livre de levar rasteira de multa antiga.",
    "lei 12727 de 2012": "Essa lei deu o retoque final no Código Florestal novo. Ela mudou alguns pedacinhos da lei principal e colocou aquela regra importante de que, após 5 anos, o banco só daria crédito para quem estivesse com o CAR em dia.",
    "decreto 7830 de 2012": "Esse decreto foi o que deu vida ao CAR e ao SICAR no papel, logo depois que a lei principal foi aprovada. Ele explicou o que era o cadastro, como funcionaria a regularização ambiental e o que o governo esperava de cada proprietário.",
    "lei 12651 de 2012": "Essa aqui é a mãe de todas as regras atuais da roça! É o famoso **Novo Código Florestal**. Foi essa lei que mudou tudo no Brasil: perdoou parte das exigências de quem tinha sítio pequeno, criou o CAR, o PRA, definiu o tamanho das APPs na beira dos rios e fixou a data de 22 de julho de 2008 como o marco divisório da história ambiental do país.",
    "decreto 6514 de 2008": "Esse decreto é a tabela de preços das multas do meio ambiente. Ele diz o tamanho do castigo financeiro para cada infração ambiental, seja por desmatar, queimar ou poluir, e explica como funciona o processo para se defender no Ibama.",
    "lei 11428 de 2006": "É a famosa **Lei da Mata Atlântica**. Como esse bioma já foi muito castigado na história do Brasil, criaram essa lei dura para proteger o que restou de floresta nativa nele. Ela proíbe ou dificulta muito qualquer tipo de desmatamento em áreas de Mata Atlântica.",
    "lei 11284 de 2006": "Essa lei criou o Serviço Florestal Brasileiro (o SFB, que cuida do CAR hoje) e explicou como o governo pode fazer a concessão de florestas públicas, ou seja, alugar florestas do governo para empresas tirarem madeira de forma sustentável, sem destruir nada.",
    "lei 10650 de 2003": "É a lei que garante o direito de fofocar sobre o meio ambiente! Ela diz que qualquer cidadão tem o direito de ir no órgão ambiental e pedir para ver os dados e informações sobre a natureza, poluição ou desmatamento, e o governo não pode esconder.",
    "medidas provisorias de 1996 a 2001": "Essa dinastia de MPs (como a famosa 2.166-67) foi uma época em que o governo mudava o Código Florestal antigo quase todo mês por meio de medidas provisórias. Foi numa dessas MPs que a exigência de Reserva Legal na Amazônia subiu de 50% para 80%, pegando muito produtor de surpresa na época.",
    "lei 9985 de 2000": "Essa lei criou o SNUC (Sistema Nacional de Unidades de Conservação). É o livro de regras que explica como nascem e funcionam os Parques Nacionais, as Reservas Biológicas e as RPPNs, dividindo o que é área de proteção total e o que é área de uso sustentável.",
    "decretos e leis de 1989 a 1994": "Esse pacote de normas (Leis 7.803, 7.754 e os decretos da época) trouxe as primeiras grandes mudanças no Código Florestal antigo. Foi nessa época que começaram a exigir que a Reserva Legal fosse registrada na matrícula do cartório e que as beiras de rios menores ganhassem mais proteção.",
    "lei 5868 de 1972": "Essa lei antiga criou o Sistema Nacional de Cadastro Rural (aquele que gerou o CCIR que você paga no Incra). Ela foi feita para o governo saber quem era o dono de cada pedaço de chão no Brasil, focando na parte produtiva e nos impostos da terra.",
    "lei 4771 de 1965": "Esse foi o **Velho Código Florestal** do Brasil. Ele durou quase cinquenta anos! Foi ele quem inventou o conceito de Reserva Legal e de Área de Preservação Permanente (APP) no país, mas como era muito antigo, acabou sendo trocado pela lei nova de 2012.",
    "lei 4504 de 1964": "É o famoso **Estatuto da Terra**. Uma lei histórica que nasceu para organizar os direitos do homem do campo, falar sobre reforma agrária e definir a função social da terra (dizendo que o sítio tem que produzir, mas também tem que respeitar as leis e os trabalhadores).",
    "decreto 23793 de 1934": "Esse é o primeiríssimo Código Florestal do Brasil, feito no tempo de Getúlio Vargas! Naquela época, o governo já estava preocupado com o sumiço das madeiras de lei e criou a primeira regra dizendo que todo mundo que tivesse terra tinha que guardar pelo menos 25% da propriedade com a mata nativa de pé. Mal sabiam eles que essa conversa ia longe!"

// ==========================================
    // GRUPO 26: CONCEITO GERAL DO CAR (BOLETINS)
    // ==========================================
    "o que e o car de verdade": "O CAR é um registro público que roda todo pela internet no Brasil inteiro. Ele nasceu com o novo Código Florestal de 2012 e serve para juntar num computador só a radiografia ambiental de cada sítio, fazenda ou posse do país. É ali que o governo confere onde tem mata nativa, onde estão as beiras de rio (APP), as áreas de Reserva Legal e o que já foi desmatado e virou pasto ou lavoura, ajudando a planejar a economia e a combater a derrubada ilegal.",
    "primeiro passo para regularizar": "Fazer a inscrição no CAR é o primeiríssimo passo para você ficar de boa com as leis da natureza e do governo. Nesse cadastro, você declara três coisas principais: quem é você (seus dados de dono ou posseiro), os papéis que provam que a terra é sua (ou que você cuida dela) e o desenho georreferenciado (o mapa de satélite) mostrando os limites do seu terreno e onde ficam as matas e as benfeitorias.",

    // ==========================================
    // GRUPO 27: OS MANUAIS E MÓDULOS DO SISTEMA
    // ==========================================
    "modulo de cadastro pre preenchido": "Esse módulo pré-preenchido é uma mão na roda! Em vez de você digitar tudo do zero, você entra no sistema usando a sua conta GOV.BR e ele já puxa sozinho os seus dados, os papéis do seu imóvel e, se tiver, até os mapas que já estão salvos no Incra. A sua única função é dar uma revisada, completar o que faltar e confirmar. O próprio sistema te dá uns alertas se achar alguma coisa estranha, o que evita erros e faz o processo andar bem mais rápido.",
    "modulo de cadastro offline": "O módulo offline é aquele programinha que você baixa e instala no computador para preencher o CAR mesmo se não tiver internet na sua casa ou no escritório. Você consegue digitar os dados do dono, os papéis da posse e desenhar os mapas no sossego do seu sítio. As únicas horas que você vai precisar caçar uma internet são para baixar as fotos de satélite do seu município no começo e, no final, para mandar o arquivo **.car** pronto para o governo.",
    "o que e o arquivo ret": "O arquivo com final **.ret** é o 'arquivo de retificação'. Quando você precisa consertar alguma coisa no seu CAR através da Central do Proprietário, o sistema te dá esse arquivo para você abrir de volta no programa do computador. Ele já vem com tudo o que você tinha preenchido antes, aí você só arruma o pedaço que estava errado, sem precisar refazer o trabalho todo.",
    "o que e retificacao dinamizada": "A Retificação Dinamizada é uma ferramenta do sistema que ajuda a corrigir o seu CAR quase que no automático. Depois que o computador do governo passa um 'pente fino' digital no seu mapa (a chamada Análise Dinamizada) e acha alguma diferença entre o que você desenhou e o que o satélite deles mostra, o próprio sistema te propõe uma correção inteligente.",
    "condicoes da analise dinamizada": "Depois que o computador roda a Análise Dinamizada, o seu imóvel pode cair em três situações: **Analisado, Aguardando Retificação Dinamizada** (quando o sistema achou erro no seu desenho e está te sugerindo um conserto), **Analisado, Aguardando Regularização** (quando o seu desenho está perfeito, mas o sistema viu que você está devendo mata de APP ou Reserva e precisa assinar um acordo), ou **Analisado sem pendência** (quando está tudo 100% perfeito e aprovado).",
    "aceitar ou nao a retificacao": "Se o seu CAR estiver 'Aguardando Retificação Dinamizada', você entra na Central, abre o Relatório de Revisão e olha o que o computador sugere. Se você achar que a sugestão do sistema está certa, você clica em aceitar e o CAR corrige na hora. Se você não concordar de jeito nenhum, você recusa; aí o seu cadastro vai para a fila antiga para ser revisado com calma por um técnico de carne e osso do estado.",

    // ==========================================
    // GRUPO 28: MATURIDADE DO ECOSSISTEMA DE DADOS
    // ==========================================
    "o que e ecossistema de dados": "Falar em 'ecossistema de dados' do CAR é só um jeito bonito de dizer que as informações da sua terra não ficam presas num lugar só. Elas passeiam e são cuidadas por um mutirão de órgãos: o Ministério da Gestão, o Serviço Florestal Brasileiro, a Dataprev e as secretarias de meio ambiente de cada estado. Para o Código Florestal funcionar direito, a conversa entre os computadores de todos esses órgãos precisa estar muito bem afinada.",
    "agenda de maturidade de dados": "Desde o final de 2024, esse povo todo se juntou numa agenda técnica para medir a 'maturidade' desse sistema. Eles pegaram uma régua do governo federal (o Modelo da IND) e adaptaram para o CAR. O objetivo é fazer com que as equipes trabalhem em harmonia e vejam se os dados estão seguros, se os sistemas conversam entre si (interoperabilidade), se têm qualidade e se são transparentes para o público.",
    "participacao dos estados nos dados": "Essa checagem começou com os técnicos dos ministérios lá em Brasília e, a partir do segundo semestre de 2025, os estados que estavam com os deveres de casa em dia também entraram na roda. Afinal, como muitos estados têm sistemas próprios, eles precisam jogar no mesmo time do sistema nacional para os dados não ficarem batendo cabeça.",
    "estrategia de dados 2026 a 2028": "Toda essa avaliação serviu para criar uma Política de Governança de Dados para o CAR e desenhar a **Estratégia de Dados do CAR (2026–2028)**. O plano para esses próximos anos é fazer com que o sistema use as informações de forma cada vez mais inteligente e rápida, transformando esse monte de declarações num mapa vivo e confiável para guiar o crédito rural e proteger as nossas florestas."
};
